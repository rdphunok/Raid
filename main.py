...
def main():
    ...
    # FIX: Using filters.ALL without restricting to ~filters.COMMAND so that messages pass correctly to router
    app.add_handler(MessageHandler(filters.ALL, process_custom_commands))
