...
# ==========================================
# DIRECT COMMAND HANDLER WRAPPER (NO ERRORS)
# ==========================================

def make_command_handler(command_name, callback_func):
...
async def run_bot(token, is_master):
    ...
    # --- REACTION COMMANDS (All Bots) ---
    app.add_handler(make_command_handler("rct", start_reaction))
    app.add_handler(make_command_handler("drct", stop_reaction))
    app.add_handler(make_command_handler("arct", start_global_reaction))
    app.add_handler(make_command_handler("darct", stop_global_reaction))

    # --- MASTER BOT COMMANDS ---
    if is_master:
        app.add_handler(CommandHandler("status", status_command))
        app.add_handler(make_command_handler("status", status_command))
        
        app.add_handler(CommandHandler("menu", menu_command))
        app.add_handler(make_command_handler("menu", menu_command))
        
        app.add_handler(make_command_handler("pre", set_prefix))
        app.add_handler(make_command_handler("ptst", ping_test_command))
        app.add_handler(make_command_handler("tag", tag_all_command))
        app.add_handler(make_command_handler("clall", start_clear_all))
        app.add_handler(make_command_handler("dclall", stop_clear_all))
        app.add_handler(make_command_handler("whois", whois_command))
        app.add_handler(make_command_handler("tts", tts_command))
        app.add_handler(make_command_handler("sudo", add_sudo))
        app.add_handler(make_command_handler("unsudo", remove_sudo))
        
        app.add_handler(CommandHandler("sudos", list_sudo))
        app.add_handler(make_command_handler("sudos", list_sudo))
        
        app.add_handler(make_command_handler("raid", start_raid))
        app.add_handler(make_command_handler("draid", stop_raid))
        app.add_handler(CommandHandler("re", start_reply))
        app.add_handler(make_command_handler("re", start_reply))
        app.add_handler(CommandHandler("dre", stop_reply))
        app.add_handler(make_command_handler("dre", stop_reply))
        app.add_handler(make_command_handler("cre", start_custom_reply))
        app.add_handler(make_command_handler("dcre", stop_custom_reply))
